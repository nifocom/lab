...
AnimationInfo.prototype.formatImgSourcesArray = function(arrayData, path, ext)
{
    var preparedArray = [];
...
AnimationInfo.prototype.initFromArr = function(imagesArray, name, frameAnim )
{
...
AnimationInfo.prototype.scheduleAnimation = function(/*TODO: insert stopFrameNumber and direction*/)
{
...
AnimationInfo.prototype.getNext = function()
{
...
AnimationInfo.prototype.reset = function( )
{
    this.currFrameIdx = 0;
    this.direction = 'none';
    this.animationStartTime =  null;
